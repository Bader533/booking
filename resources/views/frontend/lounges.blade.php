        ...
        <div class="mb-0" id="home">
            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                ...
                <div class="d-flex flex-column flex-center">
                    <!--begin::Heading-->
                    <div class="text-center mb-5 mb-lg-10 py-10">
                        <!--begin::Title-->
                        ...
                        <div class="row">
                            <form action="" class="flexbox">
                                <input type="text" placeholder="your place" class="form-control input flex" />
            ...
            <div class="container mt-4">
                <div class="card">
                    <div class="row no-gutters" id="rowwww" style="background: #ebeded;">
                        <div class="col-md-4" style="width: 228px;">
                        ...
                        <div class="col-md-8">
                            <div class="card-body" style="padding-left: 5px;padding-top: 5px;">
                                ...
                                <h5 class="card-title" style="font-size: 23px;font-weight: 400;float: left;">
                                    <a style="color: black" href="{{ route('lounge.details', $lounge->slug) }}">
                                        {{ $lounge->name }} </a>
                                </h5>
                                <button class="btn btn-primary"
                                    style="float: right;padding-bottom: 5px;padding-top:5px;">add</button>
