                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select form-select-solid" name="client_kind" id="client_kind"
                                ...
                                <option></option>
                                <option value="visitor" @if ($client->client_kind == 'visitor') selected @endif>
                                    {{ __('site.visitor') }}
                                </option>
                                <option value="resident" @if ($client->client_kind == 'resident') selected @endif>
                                    {{ __('site.resident') }}
                                </option>
                                <option value="citizen" @if ($client->client_kind == 'citizen') selected @endif>
                                    {{ __('site.citizen') }}
                                </option>
                                <option value="a_gulf_citizen" @if ($client->client_kind == 'a_gulf_citizen') selected @endif>
                                    {{ __('site.a_gulf_citizen') }}</option>
                            </select>
                            <!--end::Input-->
                            <!--end::client_kind-->
                                ...
                                {{-- <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="id_kind" id="id_kind"
                                                value="{{ $client->id_kind }}" class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::id_kind-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="id_copy" id="id_copy"
                                                value="{{ $client->id_copy }}" class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::id_copy-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="visa_number" id="visa_number"
                                                class="form-control mb-2" value="{{ $client->visa_number }}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::visa_number-->
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="date" name="sign_in" id="sign_in"
                                                value="{{ $client->sign_in }}" class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::sign_in-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="number" name="duration" id="duration"
                                                value="{{ $client->duration }}" class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::duration-->
