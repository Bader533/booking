...
@section('name')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
            {{ __('site.dashboard') }}</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">
                <a href="{{ route('dashboard.page') }}" class="text-muted text-hover-primary">{{ __('site.dashboard') }}</a>
            </li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{{ __('site.booking') }}</span>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-4">
                                    <!--begin::Search-->
                                    <a href="{{ route('booking.create') }}"
                                        class="btn btn-light btn-sm">{{ __('site.add_new_booking') }}</a>
                                    <!--end::Search-->
                                </div>
                                <!--begin::Filters-->
                            </div>
