                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input name="night_price" id="night_price" value="{{ $lounge->night_price }}"
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" id="name" value="{{ $lounge->name }}"
                                                class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::name-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="city" id="city" value="{{ $lounge->city }}"
                                                class="form-control
                                        mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="address" id="address"
                                                value="{{ $lounge->address }}" class="form-control mb-2" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::address-->
                                    </div>
                                        ...
                                        <div class="container">
                                            @foreach ($lounge->images as $image)
                                                <div class="image">
                                                    ...
                                                    <span onclick="performDelete({{ $image->id }})">
...
@section('js')
    <script>
        ...
        function update() {
            ...
            axios.post('/lounge/{{ $lounge->slug }}', formData)
                .then(function(response) {
